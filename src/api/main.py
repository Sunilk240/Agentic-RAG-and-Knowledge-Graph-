...
from src.core.interfaces import QueryAnalysis, SynthesisResult, QueryType, RetrievalStrategy
...
async def health_check():
    ...
    try:
        ...
        try:
            from src.core.database import get_neo4j_manager
        ...
        try:
            from src.core.database import get_vector_manager
...
async def upload_document(request: DocumentUploadRequest):
    ...
    **Domain-Specific Processing:**
    ...
    try:
        ...
        from src.core.ingestion_pipeline import DualStorageIngestionPipeline
        from src.core.database import get_neo4j_manager, get_vector_manager
        from src.core.document_processor import DocumentProcessor
        from src.core.domain_processor import DomainProcessorManager
        from src.core.mapping_service import EntityVectorMappingService
...
async def startup_event():
    ...
    try:
        ...
        from src.core.agent_registry import initialize_agent_registry
        from src.core.message_queue import initialize_message_queue
...
async def shutdown_event():
    ...
    try:
        from src.core.database import close_databases
    ...
    try:
        from src.core.agent_registry import shutdown_agent_registry
        from src.core.message_queue import shutdown_message_queue
